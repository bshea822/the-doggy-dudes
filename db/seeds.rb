...
Pickup.create(dog_id: 1, user_id: 1, service_id: 1, pickup_date: Date.parse("06/11/2018"))
Pickup.create(dog_id: 1, user_id: 1, service_id: 2, pickup_date: Date.parse("05/11/2018"))
# Pickup.create(dog_id: 1, user_id: 1, service_id: 3, pickup_date: Date.parse("04/11/2018"))
# Pickup.create(dog_id: 2, user_id: 1, service_id: 3, pickup_date: Date.parse("03/11/2018"))
# Pickup.create(dog_id: 2, user_id: 1, service_id: 2, pickup_date: Date.parse("02/11/2018"))
# Pickup.create(dog_id: 2, user_id: 1, service_id: 1, pickup_date: Date.parse("01/11/2018"))
